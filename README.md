...
• OBJECTIVE: A CHIP THAT UNLOCKS A DOOR ONLY WHEN THE CORRECT 8-DIGIT CODE IS ENTERED. IF THE USER ENTERS THE SEQUENCE CORRECTLY, THE DOOR UNLOCKS. IF A WRONG DIGIT IS ENTERED, THE SYSTEM RESETS AND STARTS OVER.

designed using Verilog HDL, implementing:
Clock, reset, input

The Verilog was synthesized into a gate-level netlist using Cadence Genus.

Area utilization after synthesis was analyzed

Static Timing Analysis (STA) was performed

Power estimation was carried out to evaluate dynamic and leakage power consumption.

The synthesized netlist was analyzed
